...
public class MeshSimplificationApp implements SceneGraphNode, Interactor {
    ...
    public MeshSimplificationApp() {    
        ...
        EasyViewer ev = new EasyViewer("Comp 557 Mesh Simplification - Qianyu Huang 260669624", this, new Dimension(400, 400), new Dimension(600, 650) );
        ...
        component.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                if (e.getKeyCode() == KeyEvent.VK_SPACE) {
                	...
                	currentHE = heds.collapseCandidate();
